document.getElementById('Job-Select').addEventListener('change', function () {
    ...
    let desc = "Job Description:<br><span class='focused job-desc'>";
    ...
    jobvalue.innerHTML = "Selected Job:<br><span class='focused job-desc'>" + selectedText + "</span><br>Department/Division:<br><span class='focused job-desc'>" + selectedCategory + "</span>";
